#!/bin/bash
#SBATCH --job-name=covid_npe_light
#SBATCH --output=logs/slurm_npe_light_%j.out
#SBATCH --error=logs/slurm_npe_light_%j.err
#SBATCH --ntasks=1
...
echo "=========================================="
echo "Neural Posterior Estimation - COVID TIV (LIGHT/TEST RUN)"
echo "=========================================="
...
OUTPUT_DIR="results/npe/${RUN_TIMESTAMP}_light"
