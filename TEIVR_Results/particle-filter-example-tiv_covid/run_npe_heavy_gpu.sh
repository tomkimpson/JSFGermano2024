#!/bin/bash
#SBATCH --job-name=covid_npe_heavy_gpu
#SBATCH --output=logs/slurm_npe_heavy_gpu_%j.out
#SBATCH --error=logs/slurm_npe_heavy_gpu_%j.err
#SBATCH --ntasks=1
...
echo "=========================================="
echo "Neural Posterior Estimation - COVID TIV (HEAVY GPU RUN)"
echo "=========================================="
...
# HEAVY RUN Configuration
# 10x more training data for better posterior approximation
...
OUTPUT_DIR="results/npe/${RUN_TIMESTAMP}_heavy_gpu"
...
echo "=========================================="
echo "HEAVY RUN CONFIGURATION"
echo "=========================================="
echo "  Number of trajectories: $NUM_TRAJECTORIES (10x standard)"
echo "  Number of timepoints: $NUM_TIMEPOINTS"
echo "  Number of workers: $NUM_WORKERS"
echo "  Batch size: $BATCH_SIZE (2x standard)"
echo "  Max epochs: $MAX_EPOCHS (2x standard)"
echo "  Training fraction: $TRAINING_FRACTION"
echo "  Patients: $PATIENTS"
echo "  Posterior samples: $NUM_SAMPLES (5x standard)"
...
echo "  Stage 1 (Simulate): ~2-3 hours"
echo "  Stage 2 (Train): ~15-30 minutes"
echo "  Stage 3 (Infer): ~5-10 minutes"
echo "=========================================="
echo ""
...
if [ "$SKIP_SIMULATE" = false ]; then
    echo "=========================================="
    echo "STAGE 1: SIMULATE (100k trajectories)"
    echo "=========================================="
...
if [ "$SKIP_TRAIN" = false ]; then
    echo "=========================================="
    echo "STAGE 2: TRAIN (GPU-ACCELERATED, HEAVY)"
    echo "=========================================="
...
if [ "$SKIP_INFER" = false ]; then
    echo "=========================================="
    echo "STAGE 3: INFER (GPU-ACCELERATED, 50k samples)"
    echo "=========================================="
...
echo ""
echo "Heavy run summary:"
echo "  - 100,000 training simulations (10x standard)"
echo "  - 200 training epochs (2x standard)"
echo "  - 50,000 posterior samples (5x standard)"
echo "  - This should provide more robust, reproducible posteriors"
echo "=========================================="
