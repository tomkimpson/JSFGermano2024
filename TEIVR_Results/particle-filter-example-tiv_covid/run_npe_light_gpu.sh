#!/bin/bash
#SBATCH --job-name=covid_npe_light_gpu
#SBATCH --output=logs/slurm_npe_light_gpu_%j.out
#SBATCH --error=logs/slurm_npe_light_gpu_%j.err
#SBATCH --ntasks=1
...
echo "=========================================="
echo "Neural Posterior Estimation - COVID TIV (LIGHT/TEST RUN - GPU)"
echo "=========================================="
...
# Configuration - LIGHT parameters for testing
NUM_TRAJECTORIES=100
NUM_TIMEPOINTS=10
NUM_WORKERS=4
PATIENTS="432192"  # Just one patient for testing
NUM_SAMPLES=100

# Create timestamped output directory (shared across all stages)
RUN_TIMESTAMP=$(date +%Y%m%d_%H%M%S)
OUTPUT_DIR="results/npe/${RUN_TIMESTAMP}_light_gpu"
