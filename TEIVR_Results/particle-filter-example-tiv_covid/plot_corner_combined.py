...
def plot_combined_corner(
    patient_id: str,
    npe_dir: str = "npe_outputs_saved/inference",
    pf_dir: str = "outputs4",
    n_particles: int = 6000,
    output_dir: str = None,
...
Examples:
  ...
  python plot_corner_combined.py --patient 432192 --npe-dir npe_outputs/inference --pf-dir outputs4

  # Custom output location
  python plot_corner_combined.py --patient 432192 --output-dir ./comparison_plots
        """
    )
    ...
    parser.add_argument(
        ...
        help='Directory containing NPE inference results (default: npe_outputs_saved/inference)'
    )
    parser.add_argument(
        '--pf-dir',
        type=str,
        default='outputs4',
        help='Directory containing particle filter results (default: outputs4)'
    )
    parser.add_argument(
        '--particles',
        type=int,
